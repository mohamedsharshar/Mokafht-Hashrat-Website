<<<<<<< HEAD
I developed this website with both a front-end and a back-end using well-known tools such as HTML, CSS, JavaScript, PHP, and MySQL. I successfully sold it to a pest and rodent control company.
=======
# README
